public class DogTriathalonParticipant
{
  ...
  public DogTriathalonParticipant(String name, int numEvents, int score1, 
  ...
  public void display() 
  {
   System.out.println(name + " participated in " + NUM_EVENTS + " events and has an average score " + avg);
